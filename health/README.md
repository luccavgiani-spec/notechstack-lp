...
4. **Sec3 · Qual sua ideia?** — três cards de planos (Própria | **Integração com Plataforma Existente** *recomendado* | Híbrido) + tabela comparativa + CTA final. **Sem preços** em lugar nenhum.
