...
for (const id of [6, 4, 3]) {
  ...
  console.log(`cena ${id}: feetBoneY=${feetY.toFixed(3)} linha_prevista_px=${pxY.toFixed(1)}`);
  await page.screenshot({ path: path.join(ROOT, 'screenshots', `verify-overlay3-cena${id}.png`) });
}
